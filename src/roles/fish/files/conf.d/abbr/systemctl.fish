...
abbr -a -- sluf   'systemctl list-units'
abbr -a -- slufg  'systemctl list-units | grep'
## user
...
abbr -a -- suluf  'systemctl --user list-units'
abbr -a -- sulufg 'systemctl --user list-units | grep'
