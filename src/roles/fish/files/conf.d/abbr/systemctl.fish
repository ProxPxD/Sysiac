...
abbr -a -- sluf   'systemctl list-unit-files'
abbr -a -- slufg  'systemctl list-unit-files | grep'
## user
...
abbr -a -- suluf  'systemctl --user list-unit-files'
abbr -a -- sulufg 'systemctl --user list-unit-files | grep'
