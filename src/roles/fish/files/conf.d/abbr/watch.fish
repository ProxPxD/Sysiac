...
## podman
abbr -a -- wpps  'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
abbr -a -- hpps  'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
abbr -a -- hwpps 'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
abbr -a -- wp    'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
abbr -a -- hp    'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
abbr -a -- hwp   'hwatch -ctn1 -p "podman ps --format \'$PODMAN_FORMATTING\'"'
